...
app.layout = html.Div(
    [
        ...
        dcc.Markdown("[github](https://github.com/michaelmusty/UVRS2022)"),
    ]
)
...
def func(n_clicks):
    return dcc.send_data_frame(df_overall.to_csv, "uvrs2022_overall_scores.csv")
...
def func(n_clicks):
    return dcc.send_data_frame(df.to_csv, "uvrs2022_scores_for_all_races.csv")

...
path_to_5k_raw = (
    "input_data/race_data_raw/01_BarnArtRaceAroundTheLake_10k_20220522/5k_raw.csv"
)
path_to_10k_raw = (
    "input_data/race_data_raw/01_BarnArtRaceAroundTheLake_10k_20220522/10k_raw.csv"
)
...
def _process_path(path: str, which_race: str):
    ...
    logger.info(df)
    df.to_csv(
        f"input_data/race_data/01_BarnArtRaceAroundTheLake_10k_20220522/{which_race}.csv"
    )
